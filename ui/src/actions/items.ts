...
export const fetchItem: ActionCreator<ThunkAction<Promise<Action>, IRootState, void, Action>> = (itemId: number) => {
...
export const fetchItems: ActionCreator<ThunkAction<Promise<Action>, IRootState, void, Action>> = () => {
  return ActionUtil.createAsyncChain(itemAPI.getAll, {
...
export const createItem: ActionCreator<ThunkAction<Promise<Action>, IRootState, void, Action>> = (
...
export const updateItem: ActionCreator<ThunkAction<Promise<Action>, IRootState, void, Action>> = (
...
export const deleteItem: ActionCreator<ThunkAction<Promise<Action>, IRootState, void, Action>> = (itemId: number) => {
  return ActionUtil.createAsyncChain(
    itemAPI.delete,
    {
