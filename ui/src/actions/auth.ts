...
export const login: ActionCreator<ThunkAction<Promise<Action>, IRootState, void, Action>> = (
  username: string,
  password: string
) => {
...
export const logout: ActionCreator<ThunkAction<Promise<Action>, IRootState, void, Action>> = () => {
  return ActionUtil.createAsyncChain(authAPI.logout, {
...
export const checkLoginStatus: ActionCreator<ThunkAction<Promise<Action>, IRootState, void, Action>> = () => {
